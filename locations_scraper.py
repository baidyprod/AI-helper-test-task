...
def advanced_scrape_locations():
    """
    'Інформація про магазини в місті Київ': [{'Назва локації': 'ТРЦ «DOMA Center» (1 поверх)', 'Адреса': 'вул. Будівельників, 40\nст. м. «Дарниця»',
    'Номер телефону': '+38 (063) 425 49 03', 'Графік роботи': 'Пн - Пт: 10:00 - 21:30\nСб - Нд: 10:00 - 21:30'}
    """
...
def scrape_locations():
    """
   'Інформація про магазини в місті Київ': [['ТРЦ «DOMA Center» (1 поверх)', 'вул. Будівельників, 40\nст. м. «Дарниця»', '+38 (063) 425 49 03',
   'Пн - Пт: 10:00 - 21:30\nСб - Нд: 10:00 - 21:30']
    """
    with open('our_shops.html', 'r') as file:
        soup = BeautifulSoup(file, 'html.parser')
    ...
    for section in sections:
        ...
        result_dict[f'Інформація про магазини в місті {city_name}'] = [data_values[i:i + 4] for i in range(0, len(data_values), 4)]
